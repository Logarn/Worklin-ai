...
function buildSystemPrompt(
  ...
  sections.push(
    ...
    `  - Write popup copy as final copy for the account owner or recipient. Do not write instructions for the assistant or another intermediary.`,
    `  - Never expose the internal term "guardian". Use "approval request", "account owner", or "account verification" as appropriate.`,
    ...
    `  - Avoid intermediary-instruction phrasing like "consider telling the account owner", "ask the recipient to", or "the assistant should remind them". Rewrite it as final copy the recipient can act on directly.`,
