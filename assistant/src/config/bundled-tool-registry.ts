...
import * as retentionScoreCustomers from "./bundled-skills/worklin-retention/tools/retention-score-customers.js";
import * as retentionShopifySnapshot from "./bundled-skills/worklin-retention/tools/retention-shopify-snapshot.js";
import * as retentionSourceStatus from "./bundled-skills/worklin-retention/tools/retention-source-status.js";
import * as retentionUnifiedCustomerView from "./bundled-skills/worklin-retention/tools/retention-unified-customer-view.js";
...
export const bundledToolRegistry = new Map<string, SkillToolScript>([
  ...
  [
    ...
    retentionShopifySnapshot,
  ],
  [
    "worklin-retention:tools/retention-klaviyo-snapshot.ts",
    retentionKlaviyoSnapshot,
  ],
  [
    "worklin-retention:tools/retention-unified-customer-view.ts",
    retentionUnifiedCustomerView,
  ],
  [
    "worklin-retention:tools/retention-compute-customer-features.ts",
    retentionComputeCustomerFeatures,
  ],
  [
    "worklin-retention:tools/retention-score-customers.ts",
    retentionScoreCustomers,
  ],
  [
    "worklin-retention:tools/retention-build-micro-segments.ts",
    retentionBuildMicroSegments,
  ],
  [
    "worklin-retention:tools/retention-find-missing-pieces.ts",
    retentionFindMissingPieces,
  ],
  [
    "worklin-retention:tools/retention-find-campaign-opportunities.ts",
    retentionFindCampaignOpportunities,
  ],
  [
    "worklin-retention:tools/retention-generate-campaign-package.ts",
    retentionGenerateCampaignPackage,
  ],
  [
    "worklin-retention:tools/retention-generate-micro-campaign-package.ts",
    retentionGenerateMicroCampaignPackage,
  ],
  ["worklin-retention:tools/retention-run-qa.ts", retentionRunQa],
  [
    "worklin-retention:tools/retention-run-retention-qa.ts",
    retentionRunRetentionQa,
  ],
  [
  ...
  [
    "worklin-retention:tools/retention-generate-audit-artifact.ts",
