...
const RAW_PROVIDER_CATALOG: ProviderCatalogEntry[] = [
  ...
  },
  {
    id: "kimi",
    displayName: "Kimi",
    subtitle: "Kimi models from Moonshot AI. Requires a Moonshot API key.",
    setupMode: "api-key",
    setupHint: "Enter your Moonshot API key to enable Kimi.",
    envVar: "MOONSHOT_API_KEY",
    credentialsGuide: {
      description:
        "Sign in to the Kimi Open Platform console and create an API key.",
      url: "https://platform.kimi.ai/console/api-keys",
      linkLabel: "Open Kimi Console",
    },
    models: [
      {
        id: "kimi-k2.6",
