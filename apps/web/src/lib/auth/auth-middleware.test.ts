...
describe("authMiddleware — one-time platform onboarding", () => {
  test("a default assistant cannot make a new account skip onboarding", async () => {
    ...
    const response = await runMiddleware(routes.assistant);
