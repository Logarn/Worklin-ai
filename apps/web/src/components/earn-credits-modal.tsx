...
function buildSubtitle(
  ...
  if (referrerAmount === refereeAmount) {
    return `Share Worklin with friends — you'll each earn ${referrerAmount} credits when they sign up, up to ${cap} total.`;
  }
  return `Share Worklin with friends — you'll earn ${referrerAmount} credits and they'll get ${refereeAmount} when they sign up, up to ${cap} total.`;
}
...
function TermsContent({ cap }: { cap: string }) {
  const bullets = [
    ...
    "Rewards are earned once your invitee completes the creation of their Worklin account.",
