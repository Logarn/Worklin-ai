  ...
  if (platformGate === "disabled") {
    return (
      <div className="space-y-4">
        <Notice tone="info">
          Log in to the Worklin platform to manage self-hosted assistants.
        </Notice>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      <DetailCard
        ...
        subtitle="Self-hosted assistants registered with your Worklin account. Registration lets these assistants use Worklin managed services — inference, web search, integrations — so that you don't have to bring your own API keys."
      >
        {isLoading ? (
