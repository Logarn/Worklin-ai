  ...
  return (
    <div className="space-y-4">
      ...
      {infraGate === "disabled" && (
        ...
        >
          <Notice tone="info">
            Log in to the Worklin platform to manage compute resources.
          </Notice>
        </DetailCard>
      )}
      ...
      {infraGate === "disabled" && (
        <DetailCard title="Software Updates">
          <Notice tone="info">
            Log in to the Worklin platform to manage software updates.
          </Notice>
        </DetailCard>
      )}
      ...
      {infraGate === "disabled" && settingsSleepPolicy && (
        ...
        >
          <Notice tone="info">
            Log in to the Worklin platform to manage sleep policy.
          </Notice>
        </DetailCard>
      )}
      ...
      {platformGate === "disabled" && !canRetireLocally && (
        ...
        >
          <Notice tone="info">
            Log in to the Worklin platform to retire this assistant.
          </Notice>
        </DetailCard>
      )}
