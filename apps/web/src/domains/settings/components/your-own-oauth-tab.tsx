          ...
          <Card.Body className="flex flex-col gap-3">
            <div className="space-y-1">
              ...
              <p className="text-body-small-default leading-relaxed text-[var(--content-tertiary)]">
                Credentials are encrypted and stored only for this assistant. On
                a Worklin-hosted assistant, Worklin securely processes and
                stores them; on a self-hosted assistant, they stay in your
                environment.
              </p>
            </div>
            {oauthCallbackUrl ? (
