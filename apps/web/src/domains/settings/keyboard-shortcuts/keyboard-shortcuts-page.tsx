  ...
  [
    {
      ...
      description: "Work anywhere, even when Worklin is in the background.",
    },
    {
      scope: "menu",
      title: "App shortcuts",
      description: "Work while a Worklin window is focused.",
    },
  ];
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-body-medium-lighter text-[var(--content-secondary)]">
          Customize the shortcuts for Worklin&apos;s commands.
        </p>
      </div>
